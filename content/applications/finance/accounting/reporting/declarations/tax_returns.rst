...
business, while the **input tax** is the tax added to the price when goods or services are purchased.
Based on these values, the company can calculate the tax amount they have to pay or be refunded.

.. note::
   You can find additional information about VAT and its mechanism on `this page from the European Commission
...
You can see the :guilabel:`Tax Grids` by opening any :guilabel:`Invoice` and :guilabel:`Bill` in the
:guilabel:`Journal Item tab`.
...
Therefore, we recommend locking your tax date before working on your :guilabel:`Closing Journal Entry`.
